/*****************************************************************************
* Filename:          D:\RA198-2016\lab3/drivers/my_peripheral_v1_00_a/src/my_peripheral_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the my_peripheral driver
* Date:              Fri Mar 22 09:40:16 2019 (by Create and Import Peripheral Wizard)
*****************************************************************************/
...
XStatus MY_PERIPHERAL_SelfTest(void * baseaddr_p)
{
  ...
  if ( (MY_PERIPHERAL_mReadSlaveReg0 (baseaddr, 0)) != 0x0){
