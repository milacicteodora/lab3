...
Peripheral Summary:
  ...
  logical library name                       : my_peripheral_v1_00_a
  top name                                   : my_peripheral
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/my_peripheral_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/my_peripheral_v2_1_0.tcl
